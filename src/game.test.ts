...
describe.concurrent('game behavior', () => {
  ...
  it('updates en passant target correctly', () => {
    ...
    game.makeMove(new PotentialMove(
        game.board.board[7][1],
        game.board.board[5][2]
      )
    )
    expect(game.enPassantTarget).toBe(null)
    game.makeMove(new PotentialMove(
        game.board.board[0][1],
        game.board.board[2][2]
      )
    )
    expect(game.enPassantTarget).toBe(null)
    game.makeMove(new PotentialMove(
        game.board.board[6][3],
        game.board.board[5][3]
      )
    )
    expect(game.enPassantTarget).toBe(null)
    game.makeMove(new PotentialMove(
        game.board.board[1][3],
